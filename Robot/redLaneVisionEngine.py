...
class vision:
    ...
    def __init__(self):
        ...
        self.__blur_radius = 30.0#16.216216216216218

        self.blur_output = None

        self.__rgb_threshold_input = self.blur_output
        self.__rgb_threshold_red = [200.0, 255.0]
        self.__rgb_threshold_green = [0.0, 177.0]
        self.__rgb_threshold_blue = [0.0, 177.0]
